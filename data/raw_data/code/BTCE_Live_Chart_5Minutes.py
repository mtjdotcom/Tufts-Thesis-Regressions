...
def bid_askTicker():     
    try:
        ...
        currentBid, currentBidVol = bids[0]
        currentAsk, currentAskVol = asks[0]
        
        return currentBid, currentBidVol, currentAsk, currentAskVol
    except HTTPError:
...
def tradeDataFeed():
    ...
    availableSymbols =  ["btc_usd", "btc_rur", "btc_eur", "ltc_usd", "lect_rur", "ltc_eur", "ltc_btc", "nmc_btc", "nmc_usd", "nvm_btc", "nvc_usd", "usd_rur",
                      "eur_usd", "trc_btc", "ppc_btc", "xpm_btc"]
    symbol = "btc_usd"
    ...
    #Daily Low and High and Average
    high = ticker["high"]
    low = ticker["low"]
    avg = ticker["avg"]
